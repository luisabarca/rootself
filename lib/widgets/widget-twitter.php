...
class Pi_Twitter_Widget extends WP_Widget {
	...
	function Pi_Twitter_Widget() {
		...
		$this->WP_Widget( 'pi_twitter_widget', 'Yourself: Twitter', $widget_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		$show_follow = $instance['show_follow']; ?>
			...
			pi_twitter_plugin($username, $show_number, false, true, false);
			
			if ( $show_follow == 'yes' ) 
				echo '<p class="follow-me"><a title="'.$instance['follow_text'].'" href="http://twitter.com/'.$username.'">'.$instance['follow_text'] .'</a></p>';
