...
function optionsframework_options() {
	...
	$cycle_transition_effect =  array("scrollLeft" => "Left", "scrollRight" => "Right", "scrollUp" => "Up", "scrollDown" => "Down");
	
	$slider3d_files = array("image" => "Image", "swf" => "Flash");
	
	$question = array("yes" => "Yes", "no" => "No");
	
	$predefined_skins = array("white.css" => "White", "red.css" => "Red", "Black" => "Black");
	...
	$blog_style = array( 'blog-1' => $imagepath . 'blog-1.png', 'blog-2' => $imagepath . 'blog-2.png', 'blog-3' => $imagepath . 'blog-3.png');
	...
	$options[] = array( "name" => __("Skin Manager", "theme_textdomain"),
						"desc" => __("Customization features are only available with Premium Version. If you want to change any design aspect of your site: color, typography, menus, backgrounds, and so on, you can do it. <a href=\"http://themeyourself.com/upgrade/\">Click to read more about Premium Version and how to upgrade it</a>.", "theme_textdomain"),
						"id" => "skin_generator",
						"std" => "custom",
						"type" => "radio",
						"options" => array(
	...
	$options[] = array( "name" => __("Body Font", "theme_textdomain"),
						"id" => "skin_body_font",
						"std" => array('size' => 13,'face' => 'Droid Serif','style' => 'normal','color' => '#555555'),
						"type" => "typography",
						"heading" => "h5");
	...
	$options[] = array( "name" =>  __("Body Background", "theme_textdomain"),
						...
						"std" => array('color' => '#fafafa', 'image' => '110.png', 'repeat' => 'repeat','position' => 'left top','attachment'=>'scroll'), 
						"type" => "background",
						"heading" => "h5");
	...
	$options[] = array( "name" => __("Border Bottom", "theme_textdomain"),
						...
						"std" => array('border-style' => 'none', 'size' => 1, 'color' => '#f0f0f0'),
						"type" => "border",
						"heading" => "h5");
						
	$options[] = array( "name" => __("Shadow Bottom", "theme_textdomain"),
						"id" => "skin_header_shadow_bottom",
						"std" => array('display' => 'enable', 'h-size' => 1, 'v-size' => 1, 'color' => '#f9f9f9'),
						"type" => "shadow",
						"heading" => "h5");
	...
	$options[] = array( "name" => __("Logo Typography", "theme_textdomain"),
						...
						"std" => array('size' => 16,'face' => 'Lato','style' => 'bold','color' => '#333333'),
						"type" => "typography",
						"heading" => "h5");
						
	$options[] = array( "name" => __("Typography", "theme_textdomain"),
						"id" => "skin_header_menu_font",
						"std" => array('size' => 12,'face' => 'Droid Sans','style' => 'bold','color' => '#757575'),
						"type" => "typography",
						"heading" => "h5");
						
	$options[] = array( "name" => __("Typography Shadow", "theme_textdomain"),
						"id" => "skin_header_shadow_font",
						"std" => array('display' => 'enable', 'h-size' => 1, 'v-size' => 2,  'color' => '#000000'),
						"type" => "shadow",
						"heading" => "h5");
	...
	$options[] = array( "name" => __("Shadow", "theme_textdomain"),
						...
						"std" => array('display' => 'enable', 'h-size' => 1, 'v-size' => 1, 'color' => '#f7f7f7'),
						"type" => "shadow",
						"heading" => "h5");
	...
	$options[] = array( "name" => __("Shadow", "theme_textdomain"),
						"id" => "skin_main_shadow",
						"std" => array('display' => 'enable', 'h-size' => 1, 'v-size' => 2, 'color' => '#f8f8f8'),
						"type" => "shadow",
						"heading" => "h5");
	...
	$options[] = array( "name" => __("Typography", "theme_textdomain"),
						"id" => "skin_footer_font",
						"std" => array('size' => 13,'face' => 'Droid Sans','style' => 'normal','color' => '#aaaaaa'),
						"type" => "typography",
						"heading" => "h5");
	...
	$options[] = array( "name" => __("Background", "theme_textdomain"),
						...
						"std" => array('color' => '#6e99b9', 'image' => '', 'repeat' => 'repeat', 'position' => 'left top','attachment'=>'scroll'), 
						"type" => "background",
						"heading" => "h5");
	...
	$options[] = array( "name" => __("Enable Homepage Slider", "theme_textdomain"),
						"desc" => __("Check this to enable a homepage slider.", "theme_textdomain"),
						"id" => "enable_homepage_slider",
						"std" => "0",
	...
	$options[] = array( "name" => __("Blog Style", "theme_textdomain"),
						"desc" => __("Select the style for your blog page.", "theme_textdomain"),
						"id" => "blog_style",
						"std" => "blog-1",
						"type" => "images",
						"options" => $blog_style );
	...
	$options[] = array( "name" => __("Transition Effect", "theme_textdomain"),
						"desc" => __("Choose the transition effect between different slides.", "theme_textdomain"),
						"id" => "blog_nivo_transition_effect",
						"type" => "select",
						"options" => $nivo_transition_effect );
	
	$options[] = array( "name" => __("Pause Time", "theme_textdomain"),
						"desc" => __("Set the time between slides. Choose a value in milliseconds between 0 and 60000. To make manual transitions set the value to 0. Remember that 1 second = 1000 milliseconds.", "theme_textdomain"),
						"id" => "blog_nivo_pause_time",
						"type" => "number",
						"max" => 60000,
						"min" => 0,
						"std" => 4000 );	
	...
	$options[] = array( "name" => __("Transition Effect", "theme_textdomain"),
						...
						"id" => "portfolio_nivo_transition_effect",
						"type" => "select",
						"options" => $nivo_transition_effect );
	...
	$options[] = array( "name" => __("Slider Manager", "theme_textdomain"),
						...
						"options" => array(
							...
							array(
								"name" => __("Cycle Slider", "theme_textdomain"),
								"id" => "cycle",			
								"settings" => array(
									array(
										"name" => __("Height", "theme_textdomain"),
									...
									array(
										"name" => __("Transition Effect", "theme_textdomain"),
										"desc" => __("Choose the transition effect between diferent sliders.", "theme_textdomain"),
										"id" => "cycle_transition_effect",
										"type" => "select",
										"options" => $cycle_transition_effect
									),
									array(
										"name" => __("Pause Time", "theme_textdomain"),
										"desc" => __("Set the time between slides. Choose a value in milliseconds between 0 and 60000. Remember that 1 second = 1000 milliseconds.", "theme_textdomain"),
								...
								"slide_settings" => array(
									array( 
										"name" => __("Layout", "theme_textdomain"),
										"desc" => __("Select slider layout.", "theme_textdomain"),
										"id" => "cycle_layout",
										"std" => "layout-1col-fixed",
										"type" => "images",
										"options" => $layout
									...
									array(
										"name" => __("Image or Video URL", "theme_textdomain"),
										"desc" => __("Url to the image file for this slide or Vimeo/YouTube url.", "theme_textdomain"),
										"id" => "cycle_file-url",
										"type" => "upload"
									),
									array(
									...
									array(
										"name" => __("Description", "theme_textdomain"),
										"desc" => __("Optional - Add a description to your slide", "theme_textdomain"),
									...
									array(
										"name" => __("Anchor", "theme_textdomain"),
										"desc" => __("Optional - Link anchor text", "theme_textdomain"),
										"id" => "cycle_anchor",
										"type" => "text"
									)
								)
							...
							array(
								"name" => __("3D Slider", "theme_textdomain"),
								"id" => "slider3d",			
								"settings" => array(
									array(
										"name" => __("Height", "theme_textdomain"),
									...
									array(
										"name" => __("Width", "theme_textdomain"),
										"desc" => __("Set the width of your slider between 5 and 940", "theme_textdomain"),
										"id" => "slider3d_width",
										"type" => "number",
										"min" => 5,
										"max" => 940,
									...
									array(
										"name" => __("No. of piezes", "theme_textdomain"),
										"desc" => __("Number of pieces to which the item is sliced. Range between 1 and 50", "theme_textdomain"),
										"id" => "slider3d_piezes",
										"type" => "number",
										"min" => 1,
										"max" => 50,
									...
									array(
										"name" => __("Pause Time", "theme_textdomain"),
										"desc" => __("Set the time between slides. Choose a value in seconds between 0 and 19.", "theme_textdomain"),
										"id" => "slider3d_pause_time",
										"type" => "number",
										"max" => 19,
										"min" => 0,
										"std" => 3
								...
								"slide_settings" => array(
									array(
										"name" => __("File Type", "theme_textdomain"),
										"desc" => __("Select the file type for this slide.", "theme_textdomain"),
										"id" => "slider3d_file_type",
										"type" => "select",
										"std" => "image",
										"options" => $slider3d_files
									),
									array(
										"name" => __("File URL", "theme_textdomain"),
										"desc" => __("Url to image, video or flash file.", "theme_textdomain"),
										"id" => "slider3d_file-url",
										"type" => "upload"
									),
									array(
										"name" => __("Image preview URL", "theme_textdomain"),
										"desc" => __("Use image preview only with flash files.", "theme_textdomain"),
										"id" => "slider3d_preview-file-url",
										"type" => "upload"
									),
									array(
										"name" => __("Title", "theme_textdomain"),
	...
	$options[] = array( "name" => __("Sidebar Manager", "theme_textdomain"),
						"desc" => __("Create a new sidebar for your site. Insert a name and click the button.", "theme_textdomain"),
	...
	$options[] = array( "name" => __("Blog Style 1", "theme_textdomain"),
						"desc" => __("px Height - 940 px Width -OR- 620 px with Sidebar option", "theme_textdomain"),
						"id" => "img_size_blog_1",
						"class" => "mini",
						"type" => "number",
						"std" => 250,
	...
	$options[] = array( "name" => __("Blog Style 2", "theme_textdomain"),
						"desc" => __("px Height - 105 px Width -OR- 200 px with Sidebar option", "theme_textdomain"),
						"id" => "img_size_blog_2",
						"class" => "mini",
						"type" => "number",
						"std" => 90,
	...
	$options[] = array( "name" => __("Blog Style 3", "theme_textdomain"),
						"desc" => __("px Height - 300 px Width", "theme_textdomain"),
						"id" => "img_size_blog_3",
						"class" => "mini",
						"type" => "number",
						"std" => 100,
	...
	$options[] = array( "name" => __("Copyright Message", "theme_textdomain"),
						"std" => "&copy; 2011 ". get_bloginfo('name'),
						"id" => "copyright",
						"type" => "text");
						
	$options[] = array( "name" => __("WordPress Credit", "theme_textdomain"),
						"desc" => __("Enable text: Proudly powered by WordPress", "theme_textdomain"), 
						"id" => "powered_wordpress",
						"std" => "1",
						"type" => "checkbox");
						
	$options[] = array( "name" => __("Developer Credit", "theme_textdomain"),
						"desc" => __("Enable 'Developed by Marcos Fdez Villauriz'", "theme_textdomain"),
